	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="areaStudente.jsp">
					<i class="fa fa-fw fa-graduation-cap"></i>Area Studente
			</a></li>
			<li class="nav-item dropdown">
			<li class="nav-item"><a class="nav-link"> <i
					class="fa fa-fw fa-file"></i> File Studente
			</a>
		</ul>
						...
						<table class="table table-bordered" id="" width="100%"
							...
							<tbody>
								<tr>
									...
									<td><a href="<%=pf.get(i).getPathF() %>" target="_blank">
											Visualizza File </a></td>
									<td><a href="<%=pf.get(i).getPathF() %>" download
										target="_blank"> Scarica File </a></td>
									<br>
									<%} %>
								</tr>
