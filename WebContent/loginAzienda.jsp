...
<div class="container-fluid">
	...
	<div class="card-body">
					<form action="LoginAziendaServlet" method="post">
						<div class="form-group">
							<label for="exampleInputEmail1">Email: </label> <input
								class="form-control" name="azienda_email" id="studente_email"
								type="email" aria-describedby="emailHelp"
								placeholder="Inserisci email">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Password:</label> <input
								class="form-control" name="azienda_password"
						...
						<a class="btn btn-primary btn-block" href="areaAzienda.jsp">Login</a>
					</form>
