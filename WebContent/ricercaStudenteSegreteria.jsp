	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="areaSegreteria.jsp"> <i class="fa fa-fw fa-university"></i>Area
					Segreteria
			</a></li>
		</ul>
				...
				<div class="card-body">
					<form action="CercaStudenteServlet" method="post">
						<div class="form-group">
							<div class="form-row">
								<label for="exampleInputName">Nome: </label> <input
									class="form-control" name="ricerca_nome" id="studente_nome"
							...
							<div class="form-group">
								<div class="form-row">
									<label for="exampleInputLastName">Cognome: </label> <input
										class="form-control" name="ricerca_cognome"
										id="studente_cognome" type="text" aria-describedby="nameHelp"
						...
						<input class="btn btn-primary" type="submit"
							name="contact_submitted" value="Cerca" />
					</form>
				</div>
			</div>
		</div>
