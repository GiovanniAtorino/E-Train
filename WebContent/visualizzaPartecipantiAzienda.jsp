...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="areaAzienda.jsp">
					<i class="fa fa-fw fa-university"></i>Area Azienda
			</a></li>
		</ul>
		...
		<div class="container-fluid">
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Richieste partecipanti al Tirocinio:
				</div>
 <div class="card-body">
				...
				<%=s.get(i).getNome() %>
				<br> Matricola:
				<%=s.get(i).getMatricola() %>
				<br>
				<button type="button"
					onclick="redirectToServlet('AccettaStudenteTirocinioServlet', '<%=s.get(i).getNome() %>')">
					Accetta</button>

				<button type="button"
					onclick="redirectToServlet('RifiutaStudenteTirocinio', '<%=s.get(i).getNome() %>')">
					Rifiuta</button>
				<br>
				<%} %>
	...
	<script>
    	...
    	function redirectToServlet(servlet, param){
    		window.location = "./" + servlet + "?nomeS=" + param;
    	}
