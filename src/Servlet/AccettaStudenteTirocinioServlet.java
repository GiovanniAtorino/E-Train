...
/**
 * Servlet implementation class AccettaStudenteTirocinioServlet
 */
@WebServlet("/AccettaStudenteTirocinioServlet")
public class AccettaStudenteTirocinioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccettaStudenteTirocinioServlet() {
        super();
